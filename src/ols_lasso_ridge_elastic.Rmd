...
# 3. Identify numeric columns to scale (glmnet works on matrices, so all should be numeric)
# So we scale all columns in X_train and X_test
...
# 5. Scale test data using training mean and sd
